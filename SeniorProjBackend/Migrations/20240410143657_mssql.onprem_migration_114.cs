        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TestCodeFileName = table.Column<string>(type: "nvarchar(250)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastActiveDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()"),
                    Rank = table.Column<string>(type: "varchar(50)", nullable: false, defaultValue: "Newbie"),
                    RankIconURL = table.Column<string>(type: "varchar(255)", nullable: false, defaultValue: "path/to/default/rank-icon.jpg"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProblemLanguageID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProblemID = table.Column<int>(type: "int", nullable: false),
                    LanguageID = table.Column<int>(type: "int", nullable: false)
                },
