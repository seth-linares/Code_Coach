...
namespace SeniorProjBackend.Data
{
    public class AIConversations
    {
        ...
        10. **AIConversations Table**:
            ...
            *   `ConversationContent` (VARCHAR(MAX)): The entire conversation text, possibly in a structured format like JSON to preserve the flow of the conversation.
        ...
        */
        ...
        public bool? IsCompleted { get; set; } // not sure if this should be optional or not. I assume it doesn't need to be but ill leave for now
