...
using CodeCoachBackend.Data;
using CodeCoachBackend.Encryption;
using CodeCoachBackend.Middleware;
using System.Text.Json.Serialization;
using System.Threading.RateLimiting;


Console.WriteLine("Starting CodeCoachBackend\n\n\n\n");
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "CodeCoachBackend API v1");
    });
}
else
{
