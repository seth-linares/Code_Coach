...
namespace CodeCoachBackend.Migrations
{
    ...
    [Migration("20240720173351_Final_Schema")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CodeCoachBackend.Data.AIConversation", b =>
                {
            ...
            modelBuilder.Entity("CodeCoachBackend.Data.AIMessage", b =>
                {
            ...
            modelBuilder.Entity("CodeCoachBackend.Data.APIKey", b =>
                {
            ...
            modelBuilder.Entity("CodeCoachBackend.Data.Language", b =>
                {
            ...
            modelBuilder.Entity("CodeCoachBackend.Data.Problem", b =>
                {
                    b.Property<int>("ProblemID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CodeCoachBackend.Data.ProblemLanguage", b =>
                {
            ...
            modelBuilder.Entity("CodeCoachBackend.Data.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CodeCoachBackend.Data.UserSubmission", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("CodeCoachBackend.Data.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("CodeCoachBackend.Data.AIConversation", b =>
                {
                    b.HasOne("CodeCoachBackend.Data.Problem", "Problem")
                        .WithMany("AIConversations")
                        .HasForeignKey("ProblemID")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("CodeCoachBackend.Data.User", "User")
                        .WithMany("AIConversations")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CodeCoachBackend.Data.AIMessage", b =>
                {
                    b.HasOne("CodeCoachBackend.Data.AIConversation", "Conversation")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("CodeCoachBackend.Data.ProblemLanguage", b =>
                {
                    b.HasOne("CodeCoachBackend.Data.Language", "Language")
